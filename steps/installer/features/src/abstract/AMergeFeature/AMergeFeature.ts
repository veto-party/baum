...
export abstract class AMergeFeature<T extends {} | Record<string, any>, Path, From = T extends {} ? any[] | any : FromSchema<T>> extends AFeature<T, Path, From> {
  protected constructor(schema: T, key: Path extends string ? Path : undefined) {
    super(schema, key);
  }
