...
type ResolveFeaturePath<WritePath extends string | undefined, B extends string | undefined> =
...
export type MergeFeatures<A extends IFeature<any, any, any>, Path extends string|undefined, B extends IFeature<any, any, any>> = 
        ...
        B extends IFeature<infer TypeB, infer PathB, any> ? 
            PathB extends string|undefined ? 
                ToDefinitionStructureWithTupleMerge<ResolveFeaturePath<Path, PathB>, TypeB, TypeA> extends infer NewType ?
                    NewType extends {}|Record<string, any> ? 
