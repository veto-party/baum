...
export interface IRendererFeatureManager<T extends IFeature<any, any, any>> extends IFeatureRenderer<T>, IFeatureManager<T> {}

export type InferNewRenderer<WritePath, R extends IRendererManager<any> | IFeatureManager<any>, Feature extends IFeature<any, any, any>> = R extends IRendererManager<infer T> ? IRenderer<MergeFeatures<T, WritePath, Feature>> : R extends IFeatureManager<infer T> ? IRenderer<MergeFeatures<T, WritePath, Feature>> : never;
