import { CachedFN, IWorkspace } from "@veto-party/baum__core";
...
import { Edge, Graph } from 'graph-data-structure';
...
export class NetworkRenderer implements INetworkRenderer {
    ...
    private workspaceToProjectMap =  new Map<IWorkspace | undefined, {
